            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('admin/video-index') }}">Manage Video</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <form name="videoForm" id="videoForm" action="{{ url('admin/video-submit') }}" method="post"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="content_type" id="content_type"
                                        ...
                                        <option disabled value='channel'>Channel</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="video_cat_name" id="video_cat_name"
                                        ...
                                        <option value="{{$vdo->id}}">{{$vdo->video_cat_name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" id="name" value="{{ old('name') }}" placeholder="Enter Video Name">
                                </div>
                                ...
                                <div class="form-group col-md-6" id="url">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('url') is-invalid @enderror"
                                            name="url" value="{{ old('url') }}" placeholder=" Please Enter Your Url ">
                                    </div>
                                </div>
                                ...
                                <div class="row add_input_fields col-12" id="urlQuality">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="quality[]" class="form-control" id="inputEmail4"
                                            placeholder="Quality" style="width:465px;">
                                    </div>

                                    <div class="form-group col-md-5" style="margin-left:9px;">
                                        <label for="">Url</label>
                                        <input type="text" name="urls[]" class="form-control" id="inputPassword4"
                                            placeholder="Url" style="width:411px;">
                                    </div>
